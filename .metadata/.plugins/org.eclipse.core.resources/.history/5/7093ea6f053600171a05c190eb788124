/**
 * TicTacToeBoard class-Class that creates a 3x3 tic tac toe board
...
public class TicTacToeBoard {
	...
	/**
	 * TicTacToeboard constructor-Constructor that initializes board to a 3x3 array of game pieces
	 */
	...
	/**
	 * Method that gets the piece at a certain row and column of the tic tac toe board
	 * @param row the row of the board
	 * @param column the column of the board
	 * @return the game piece at that row or column, null if there is no game piece object
	 */
	...
	/**
	 * Method that sets the square at that row and column to a certain game piece
